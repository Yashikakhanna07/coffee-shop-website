...
function App() {
  ...
  const descriptions = [
    { text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq', class: 'description-1' },
    { text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq', class: 'description-3-2' },
    { text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq', class: 'description-2-2' }
  ];
...
<div className="background">
  <Header/>
  <Main/>
  <Why data={data} images={images} headings={headings} descriptions={descriptions}/>
</div>
