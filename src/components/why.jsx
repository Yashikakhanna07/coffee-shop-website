...
<div className="wrapper-4">
    ...
    <div className="group-8">
      ...
      <div className="text-14">
        ...
        {images.map((image, index) => (
          <img key={index} src={image.src} alt="" width={image.width} height={image.height} />
        ))}
      </div>
      <div className="heading group">
        {headings.map((heading, index) => (
          <p key={index} className={heading.class}>{heading.text}</p>
        ))}
      </div>
      <div className="description-6 group">
        {descriptions.map((description, index) => (
          <p key={index} className={description.class}>{description.text}</p>
        ))}
      </div>
      </div>
    </div>
    ...
    <div className="group-6">
      ...
      {data.map((item, index) => (
        <div key={index}>
          <img src={item.image} alt="" width={item.imageWidth} height={item.imageHeight} />
          <p className={item.nameClass}>{item.name}</p>
          <p className={item.descriptionClass}>{item.description}</p>
        </div>
      ))}
      <img
